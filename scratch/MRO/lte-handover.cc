...
main (int argc, char *argv[])
{
  ...
  std::string resultDir = "/workspace/ns-3-dev-git-Handover/results/";
  ...
  std::string traceFilePrefix = homeDir + resultDir + "/Scenario" + scenarioName + "/lte-tcp-x2-handover";
  ...
  if ((std::filesystem::exists(homeDir + resultDir)))
  {
